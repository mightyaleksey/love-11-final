VehicleTurnRightState = Class{__includes = BaseState}

function VehicleTurnRightState:init(entity)
  assert(entity)
  self.entity = entity
  self.timer = nil
end

function VehicleTurnRightState:enter()
...
function VehicleTurnRightState:update(dt)
